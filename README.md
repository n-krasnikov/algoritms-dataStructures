...
#### Пространственная
Алгоритм - по своей сути обычная функция которая во время выполнения может порождать рекурсию и заводить новые переменные.  
...
<details>
  <summary>Для чего ты бы использовал массив?</summary>
...
<details>
  ...
  Эти структуры хороши тем что контролируется порядок извлечения данных  
</details>
